...
for i in range(0,3):
    ...
    if Sifre==TakılanKart.get("Kartsifre"):
        ...
        lütfen yapmak istediğiniz işlemi seçiniz...""".format(TakılanKart.get("İsim"),TakılanKart.get("Soyisim")))
        Sec=input("""
        [1] Bakiye Sorgulama
        ...
        print("Hatalı Sifre Girdiniz.Kalan Hakkınız {}".format(Hak))
        Hak=-1
    elif Sifre!=TakılanKart.get("Kartsifre") and Hak==0:
...
if Sec=="1":
    ...
    print("""Kredi Kartı Borç Bakiyeniz: {} Son Ödeme Tarihli {} TL'dir.""".format
    (TakılanKart.get("KrediKartBorcTarih"),TakılanKart.get("KrediKartBorc")))
    ...
    Miktar2=int(input("Lütfen Yatırılacak Tutar Giriniz:")) 
    ...
    print("Tesekkür Eder, İyi Günler Dileriz...")
    exit()
